  ...
  const roles = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#14BD95" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-xl text-gray-500 max-w-3xl mx-auto">
            Help shape the future of DISC by applying to be part of our executive team.
            We&apos;re looking for passionate students who want to make an impact through
            technology and leadership.
          </p>
          <Button
            size="lg"
            className="mt-8 bg-[#40B4B4] hover:bg-[#369999] text-white"
            onClick={() => window.open("https://forms.gle/YourApplicationFormLink", "_blank")}
          >
            Apply Now
          </Button>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <div className="bg-[#40B4B4]/5 p-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Application Opens</h3>
                  <p className="text-sm text-[#40B4B4] font-medium">March 6th</p>
                </div>
                <div className="p-4">
                  <p className="text-gray-500 text-sm">The application form opens for all executive board positions.</p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-[#40B4B4]/5 p-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Application Closes</h3>
                  <p className="text-sm text-[#40B4B4] font-medium">March 16th</p>
                </div>
                <div className="p-4">
                  <p className="text-gray-500 text-sm">All applications must be submitted by this date.</p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-[#40B4B4]/5 p-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Interview Period</h3>
                  <p className="text-sm text-[#40B4B4] font-medium">March 17th - April 4th</p>
                </div>
                <div className="p-4">
                  <p className="text-gray-500 text-sm">Selected candidates will be invited for interviews.</p>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-[#40B4B4]/5 p-4">
                  ...
                  <p className="text-sm text-[#40B4B4] font-medium">April 1st - 9th</p>
                </div>
                <div className="p-4">
                  <p className="text-gray-500 text-sm">Offers will be sent on a rolling basis. Applicants have 48 hours to accept.</p>
                </div>
              </motion.div>
            </div>
          ...
          <div className="mt-24">
                ...
                {roles.map((role) => (
                  <Button
                    ...
                    className={`rounded-full px-4 py-2 text-sm whitespace-nowrap ${
                      activeTab === role.id ? 'bg-[#40B4B4] text-white' : 'text-gray-600 hover:text-[#40B4B4]'
                    }`}
                  >
                    {role.title}
                  </Button>
            ...
            >
              {roles.map((role) => (
                role.id === activeTab && (
                  <div key={role.id} className="bg-gradient-to-br from-[#40B4B4]/5 to-[#14BD95]/5 p-6 rounded-2xl border border-[#40B4B4]/10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <Card className="overflow-hidden border-[#40B4B4]/20 bg-white/70 backdrop-blur-sm">
                        <div className="bg-[#40B4B4]/10 p-4">
                          <h4 className="text-[#40B4B4] font-semibold">What We&apos;re Looking For</h4>
                        </div>
                      ...
                      <Card className="overflow-hidden border-[#40B4B4]/20 bg-white/70 backdrop-blur-sm">
                        <div className="bg-[#40B4B4]/10 p-4">
                          <h4 className="text-[#40B4B4] font-semibold">Why Apply</h4>
                        </div>
                        <CardContent className="pt-4">
                          <ul className="list-disc pl-5 space-y-1 text-gray-500 text-sm">
                      ...
                      <div className="md:col-span-2">
                        <Card className="overflow-hidden border-[#40B4B4]/20 bg-white/70 backdrop-blur-sm">
                          <div className="bg-[#40B4B4]/10 p-4">
                            <h4 className="text-[#40B4B4] font-semibold">Responsibilities</h4>
                          </div>
                          <CardContent className="pt-4">
                            <ul className="list-disc pl-5 space-y-1 text-gray-500 text-sm">
                      ...
                      {role.timeCommitment && (
                        <div className="md:col-span-2">
                          <Card className="overflow-hidden border-[#40B4B4]/20 bg-white/70 backdrop-blur-sm">
                            <div className="bg-[#40B4B4]/10 p-4">
                              <h4 className="text-[#40B4B4] font-semibold">Time Commitment</h4>
                            </div>
                            <CardContent className="pt-4">
                              <ul className="list-disc pl-5 space-y-1 text-gray-500 text-sm">
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h4 className="font-semibold text-lg text-gray-900 mb-2">Who can apply to be on the exec board?</h4>
              <p className="text-gray-500">Any Northwestern undergraduate or graduate student who will be enrolled during the 2025-2026 academic year is eligible to apply.</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#40B4B4]/5 to-white p-6 rounded-xl border border-[#40B4B4]/10"
            >
              <h4 className="font-semibold text-lg text-gray-900 mb-2">Do I need prior experience with DISC to apply?</h4>
              <p className="text-gray-500">While prior involvement with DISC is helpful, it&apos;s not required. We welcome fresh perspectives and are looking for passionate individuals who align with our mission.</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#40B4B4]/5 to-white p-6 rounded-xl border border-[#40B4B4]/10"
            >
              <h4 className="font-semibold text-lg text-gray-900 mb-2">Can I apply for multiple positions?</h4>
              <p className="text-gray-500">Yes, you can apply for multiple positions. Just indicate your preferences in the application form.</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#40B4B4]/5 to-white p-6 rounded-xl border border-[#40B4B4]/10"
            >
              <h4 className="font-semibold text-lg text-gray-900 mb-2">What is the time commitment for exec board members?</h4>
              <p className="text-gray-500">Time commitments vary by role, but all exec members must attend weekly meetings and fulfill their role-specific responsibilities. Most positions require 2-5 hours per week.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-[#40B4B4]/10 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <div className="max-w-xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-[#40B4B4]">Ready to Help Lead DISC?</h2>
            <p className="text-lg text-gray-500 mb-8">
              Join our executive board and be part of shaping DISC&apos;s future at Northwestern.
            </p>
